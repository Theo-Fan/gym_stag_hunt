...
class AbstractRenderer:
    def __init__(self, game, window_title, screen_size):
        ...
        self._a_sprite = Entity(
            entity_type="a_agent", location=entity_positions["agent_0"]
        )
        self._b_sprite = Entity(
            entity_type="b_agent", location=entity_positions["agent_1"]
        )
    ...
    def _update_rects(self, entity_positions):
        ...
        :return:
        """
        self._a_sprite.update_rect(entity_positions["agent_0"])
        self._b_sprite.update_rect(entity_positions["agent_1"])
